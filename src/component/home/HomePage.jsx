        ...
        <div className="home">
            <section>
                <header className="header-logo">
                    <img src="./assets/images/hotel.webp" alt="Pearl Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="pearl-color">Pearl Hotel</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="pearl-color">Pearl Hotel</span></h2>
